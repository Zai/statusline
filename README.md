...
- 🤖 **Claude Version Plugin**: Displays Claude Code version
...
#### 🤖 [Claude Version](src/plugins/claude-version/README.md)
...
│   │   └── claude-version/
│   │       ├── README.md          # 📖 Claude version plugin documentation
│   │       ├── default.json       # ⭐ Default configuration
│   │       └── index.ts           # Claude version plugin
